...
namespace Cross.BluetoothLe
{
  ...
  public enum CharacteristicPropertyType
  {
    ...
    /// <summary>Characteristic can notify value changes without acknowledgement.</summary>
    Notify = 16,

    /// <summary>Characteristic can indicate value changes with acknowledgement.</summary>
    Indicate = 32,
    ...
    // TODO: Move these to seperate enum - iOS ONLY
